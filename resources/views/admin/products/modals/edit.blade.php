        ...
        <form id="productForm" method="POST" action="{{ route('admin.products.update', $product->id) }}"
            ...
            <div class="pt-8">
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="button" id="edit-product-submit-btn"
                        onclick="document.getElementById('edit-product-confirm-modal').classList.remove('hidden')"
                ...
                <!-- Confirmation Modal -->
                <div id="edit-product-confirm-modal"
                    ...
                    <div class="bg-white p-6 max-w-md w-full">
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button"
                                onclick="document.getElementById('edit-product-confirm-modal').classList.add('hidden')"
